<%@ Page Title="Timer" Language="C#" MasterPageFile="~/Content.master" AutoEventWireup="true" CodeFile="Timer.aspx.cs" Inherits="Timer_Timer" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="body" runat="server">
    <div class="well well-lg">
        <h1>Custom Non-Visual Client Components</h1>
    </div>
    <div class="row">
        <div class="col-md-12">
