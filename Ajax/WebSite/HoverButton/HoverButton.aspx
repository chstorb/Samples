<%@ Page Title="Hover Button" Language="C#" MasterPageFile="~/Content.master" AutoEventWireup="true" CodeFile="HoverButton.aspx.cs" Inherits="HoverButton_HoverButton" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="body" runat="server">
    <div class="well well-lg">
        <h1>Creating Custom ASP.NET AJAX Client Controls</h1>
    </div>
    <div class="row">
        <div class="col-md-12">
