<%@ Page Title="Client Events" Language="C#" MasterPageFile="~/Content.master" AutoEventWireup="true" CodeFile="ClientEvents.aspx.cs" Inherits="ClientEvents_ClientEvents" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="body" runat="server">
    <div class="well well-lg">
        <h1>Lebenszyklusereignisse des AJAX-Clients</h1>
    </div>
    <div class="well">
