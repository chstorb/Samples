...
// Constructor
ScriptLibrary.HoverButton = function (element) {

    ScriptLibrary.HoverButton.initializeBase(this, [element]);

    this._clickDelegate = null;
    this._hoverDelegate = null;
    this._unhoverDelegate = null;
}
ScriptLibrary.HoverButton.prototype = {
    ...
    dispose: function () {
        ...
        ScriptLibrary.HoverButton.callBaseMethod(this, 'dispose');
    },
...
ScriptLibrary.HoverButton.registerClass('ScriptLibrary.HoverButton', Sys.UI.Control);
